...
class _TimePageState extends State<TimePage> {
  ...
  static final List<UnitItem> _timeUnits = ItemLists.timeUnits();
  Decimal amount = d("0");
  UnitItem inUnit = _timeUnits[0];
  UnitItem outUnit = _timeUnits[1];
  String _output = "";
  ...
  Widget _buildUnitSelector() {
    return Container(
      child: Row(
        ...
        children: <Widget>[
          UnitDropdown(_timeUnits, inUnit, _changeInUnit),
          Container(
            padding: EdgeInsets.symmetric(horizontal: 50),
            child: Text("=", style: MainThemeData.getTextStyle()),
          ),
          UnitDropdown(_timeUnits, outUnit, _changeOutUnit)
        ],
      ),
      decoration: BoxDecoration(
  ...
  void _submitInfo() {
    ...
    print(TimeConversions.convert(newUnit));
    _output = TimeConversions.convert(newUnit).toString() + newUnit.outMetric;
  }
